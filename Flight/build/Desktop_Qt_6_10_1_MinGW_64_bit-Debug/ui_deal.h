...
public:
    ...
    void setupUi(QWidget *Deal)
    {
        ...
        favorite_button->setStyleSheet(QString::fromUtf8(""));
        ...
        horizontalSpacer_search_2 = new QSpacerItem(20, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_search_3 = new QSpacerItem(30, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_search = new QSpacerItem(30, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Minimum);
...
"}"));
        ...
        horizontalSpacer_pag_left = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        label_pageInfo_2->setObjectName("label_pageInfo_2");

        horizontalLayout_2->addWidget(label_pageInfo_2);

        lineEdit_pageNum = new QLineEdit(paginationFrame);
        lineEdit_pageNum->setObjectName("lineEdit_pageNum");
        ...
        horizontalSpacer_pag_right = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
