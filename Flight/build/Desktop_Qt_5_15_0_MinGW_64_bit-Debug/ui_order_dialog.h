...
public:
    ...
    void setupUi(QDialog *OrderDialog)
    {
        ...
        OrderDialog->setStyleSheet(QString::fromUtf8(""));
        groupBox_ticket = new QGroupBox(OrderDialog);
        groupBox_ticket->setObjectName(QString::fromUtf8("groupBox_ticket"));
        groupBox_ticket->setGeometry(QRect(20, 20, 460, 180));
        groupBox_ticket->setStyleSheet(QString::fromUtf8(""));
        label_type_label = new QLabel(groupBox_ticket);
        label_type_label->setObjectName(QString::fromUtf8("label_type_label"));
        ...
        label_ticketNo_label->setObjectName(QString::fromUtf8("label_ticketNo_label"));
        ...
        label_ticketNo->setObjectName(QString::fromUtf8("label_ticketNo"));
        label_ticketNo->setGeometry(QRect(290, 30, 150, 20));
        label_route_label = new QLabel(groupBox_ticket);
        label_route_label->setObjectName(QString::fromUtf8("label_route_label"));
        ...
        label_company_label->setObjectName(QString::fromUtf8("label_company_label"));
        ...
        label_available_label->setObjectName(QString::fromUtf8("label_available_label"));
        label_available_label->setGeometry(QRect(20, 150, 60, 20));
        label_available = new QLabel(groupBox_ticket);
        label_available->setObjectName(QString::fromUtf8("label_available"));
        label_available->setGeometry(QRect(90, 150, 100, 20));
        groupBox_passenger = new QGroupBox(OrderDialog);
        groupBox_passenger->setObjectName(QString::fromUtf8("groupBox_passenger"));
        groupBox_passenger->setGeometry(QRect(20, 210, 460, 171));
        groupBox_passenger->setStyleSheet(QString::fromUtf8(""));
        ...
        spinBox_count->setGeometry(QRect(360, 30, 60, 25));
        ...
        label_total_label->setObjectName(QString::fromUtf8("label_total_label"));
        ...
        label_total->setGeometry(QRect(360, 70, 71, 20));
        btn_passenger = new QPushButton(groupBox_passenger);
        btn_passenger->setObjectName(QString::fromUtf8("btn_passenger"));
        btn_passenger->setGeometry(QRect(330, 100, 111, 31));
        label_flighttype = new QLabel(groupBox_passenger);
        label_flighttype->setObjectName(QString::fromUtf8("label_flighttype"));
        label_flighttype->setGeometry(QRect(20, 130, 60, 20));
        comboBox_class = new QComboBox(groupBox_passenger);
        comboBox_class->setObjectName(QString::fromUtf8("comboBox_class"));
        comboBox_class->setGeometry(QRect(90, 130, 201, 22));
        btn_confirm = new QPushButton(OrderDialog);
        btn_confirm->setObjectName(QString::fromUtf8("btn_confirm"));
        btn_confirm->setGeometry(QRect(240, 390, 80, 30));
        btn_cancel = new QPushButton(OrderDialog);
        btn_cancel->setObjectName(QString::fromUtf8("btn_cancel"));
        btn_cancel->setGeometry(QRect(360, 390, 80, 30));
        label_balance = new QLabel(OrderDialog);
        label_balance->setObjectName(QString::fromUtf8("label_balance"));
        label_balance->setGeometry(QRect(40, 380, 191, 41));
    ...
    void retranslateUi(QDialog *OrderDialog)
    {
        ...
        btn_passenger->setText(QCoreApplication::translate("OrderDialog", "\350\216\267\345\217\226\344\271\230\345\256\242\344\277\241\346\201\257", nullptr));
        label_flighttype->setText(QCoreApplication::translate("OrderDialog", "\350\210\261\344\275\215\357\274\232", nullptr));
