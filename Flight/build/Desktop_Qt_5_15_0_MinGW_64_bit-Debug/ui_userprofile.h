...
public:
    ...
    void setupUi(QWidget *UserProfile)
    {
        ...
        txt_UserAccount->setObjectName(QString::fromUtf8("txt_UserAccount"));
        txt_UserAccount->setReadOnly(true);

        formLayout->setWidget(1, QFormLayout::FieldRole, txt_UserAccount);
        ...
        txt_jianjie->setObjectName(QString::fromUtf8("txt_jianjie"));
        txt_jianjie->setReadOnly(true);

        formLayout->setWidget(2, QFormLayout::FieldRole, txt_jianjie);
        ...
        txt_yu->setObjectName(QString::fromUtf8("txt_yu"));
        txt_yu->setReadOnly(true);

        formLayout->setWidget(3, QFormLayout::FieldRole, txt_yu);
        ...
        btn_recharge->setObjectName(QString::fromUtf8("btn_recharge"));
        ...
        btn_favorites->setObjectName(QString::fromUtf8("btn_favorites"));
        ...
        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Minimum);
