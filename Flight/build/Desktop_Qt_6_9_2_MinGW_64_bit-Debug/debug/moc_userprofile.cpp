...
template <> constexpr inline auto UserProfile::qt_create_metaobjectdata<qt_meta_tag_ZN11UserProfileE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(int, bool, const QString &, const QJsonObject &)>(16, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 17 }, { QMetaType::Bool, 18 }, { QMetaType::QString, 19 }, { QMetaType::QJsonObject, 20 },
        }}),
    };
...
void UserProfile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 13: _t->onGetUserInfoResponse((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<QJsonObject>>(_a[4]))); break;
        default: ;
        }
    }
